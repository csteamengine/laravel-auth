        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/products*')) }}" href="{{ route('admin.products') }}">
                    <i class="nav-icon icon-cup"></i> Products
                </a>
            </li>
            ...
            {{--<li class="nav-item">--}}
                {{--<a class="nav-link {{ active_class(Active::checkUriPattern('admin/gallery*')) }}" href="{{ route('admin.gallery') }}">--}}
                    {{--<i class="nav-icon icon-picture"></i> Gallery--}}
                {{--</a>--}}
            {{--</li>--}}

            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/sales*')) }}" href="{{ route('admin.sales') }}">
                    <i class="nav-icon icon-graph"></i> Sales
                </a>
            </li>
