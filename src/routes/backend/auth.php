...
use Csteamengine\LaravelAuth\Controllers\Backend\Auth\Role\RoleController;
use Csteamengine\LaravelAuth\Controllers\Backend\Auth\User\UserController;
use Csteamengine\LaravelAuth\Controllers\Backend\Auth\User\UserAccessController;
use Csteamengine\LaravelAuth\Controllers\Backend\Auth\User\UserSocialController;
use Csteamengine\LaravelAuth\Controllers\Backend\Auth\User\UserStatusController;
use Csteamengine\LaravelAuth\Controllers\Backend\Auth\User\UserSessionController;
use Csteamengine\LaravelAuth\Controllers\Backend\Auth\User\UserPasswordController;
use Csteamengine\LaravelAuth\Controllers\Backend\Auth\User\UserConfirmationController;
...
Route::group([
    ...
    'as'         => 'auth.',
    'namespace'  => 'Auth',
    'middleware' => 'role:'.config('auth.users.admin_role'),
], function () {
    /*
     * User Management
     */
